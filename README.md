...
I build production-ready AI systems: LLM agents, RAG pipelines, intelligent automations, and cloud-deployed APIs. My focus is on solutions that actually run in production and deliver real business results.
...
- AI Extension Program — **University of São Paulo (USP)** (2026)
- Mastering AI Super Agents — Academia Lendária (2025)
- LLM Models & Prompt Engineering — Academia Lendária (2025)
- n8n Fundamentals & VibeCoding — Sem Codar (2025)
